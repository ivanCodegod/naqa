...
# TODO: Спросить, всего ли 4 варианта может быть по експертной группе? Потом добавить для соответсутвующих фильтров
POSSIBLE_VARIANTS_FOR_COMPLIANCE_LEVEL_CRITERION_BY_EG = '\nМожливі варіанти:\n' \
                                                         '1 - Рівень A\n' \
                                                         '2 - Рівень B\n' \
                                                         '3 - Рівень E\n' \
                                                         '4 - Рівень F\n'
# TODO: Спросить, всего ли 4 варианта может быть по по GER? Потом добавить для соответсутвующих фильтров
